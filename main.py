"""
MadLibs
Author: Gianna Walker
Period/Core: 6 


"""
color = input("Enter a color: ")
verbb = input("Enter a Verb: ")
food = input("Enter a Food: ")
name = input("Enter a Name: ")
celebrity = input("Enter a Celebrity name: ")
animal = input("Enter an Animal: ")
typeofchip = input("Enter a Flavor of chip: ")
jollyrancherflavor = input("Enter your favorite Jolly Rancher Flavor: ")
...
print("On the way home my friend and I saw", animal)
